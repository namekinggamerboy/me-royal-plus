...
module.exports = client => {
 ...
 console.log(`Callback URL: ${client.callbackURL}`);
  ...
  app.get("/add/:guildID", checkAuth, (req, res) => {
    ...
    var inviteURL = `https://discordapp.com/oauth2/authorize?client_id=674108575118786560&scope=bot&permissions=2146958847&scope=bot&guild_id=${req.params.guildID}&response_type=code&redirect_uri=https%3A%2F%2Fme-royal-plus.glitch.me%2Fcallback`;
